...
PERFIL = {
    'pt-BR': dict(
        ...
        emailRotulo='Email', confirmarNota='CPF e telefone continuam como estão na sua conta Muriki. Algo errado? Dá para corrigir em Minha conta.', confirmar='Confirmar e continuar',
    ...
    'en-US': dict(
        ...
        emailRotulo='Email', confirmarNota='Your CPF and phone stay as they are in your Muriki account. Something wrong? Fix it in My account.', confirmar='Confirm and continue',
    ...
    'es-ES': dict(
        ...
        emailRotulo='Email', confirmarNota='Tu CPF y teléfono quedan como están en tu cuenta Muriki. ¿Algo mal? Corrígelo en Mi cuenta.', confirmar='Confirmar y continuar',
